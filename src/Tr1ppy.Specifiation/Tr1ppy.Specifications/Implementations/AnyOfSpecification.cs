...
public record AnyOfSpecification<T>(IEnumerable<ISpecification<T>> Specifications) : Specification<T>
{
    /// <summary>
    /// <inheritdoc/>
    /// </summary>
    public override Expression<Func<T, bool>> Expression
    {
        get
        {
            ...
            return Specifications
                .Skip(1)
                .Aggregate(resultExpression, (current, spec) => current.OrElse(spec.Expression));
        }
    }
